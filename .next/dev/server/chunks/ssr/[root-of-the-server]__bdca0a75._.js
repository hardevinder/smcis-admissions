...
"[project]/app/enquiry/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EnquiryPage() {
    ...
    const handleSubmit = async (event)=>{
        ...
        if (!formData.parent_name.trim()) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire("Parent Name Required", "Please enter parent / guardian name.", "warning");
            return;
        }
        ...
        if (!formData.class_interested) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire("Class Required", "Please select admission class.", "warning");
            return;
        }
        ...
        try {
            ...
            if (!response.ok) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire("Error", message, "error");
                return;
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bdca0a75._.js.map